...
//     ui_.radarRangeCm->add_on_state_callback(std::bind(&UserIntf::onRadarRangeCmUpdated, this,
//     _1)); ui_.audioVolPct->add_on_state_callback(std::bind(&UserIntf::onAudioVolPctUpdated, this,
//     _1)); ui_.ledBrightPct->add_on_state_callback(std::bind(&UserIntf::onLedBrightPctUpdated,
//     this, _1)); ui_.startButton->add_on_press_callback(std::bind(&UserIntf::onStartButtonPressed,
//     this));
// }
...
// void UserIntf::onStartButtonPressed() {
//     SS_LOGI("startButton pressed");
//     if (ctrlQ_ != nullptr) {
//         uint32_t session = getNumber(kSessionMinsKey, ctrl::kDefaultSessionMins);
//         ctrlQ_->post(ctrl::CmdStart{session});
//     }
// }
